...
<html class="backend">
    ...
    <head>
        ...
        <!--/ Plugins stylesheet : optional -->
        <link rel="stylesheet" href="<?php echo $this->webroot; ?>plugins/gritter/css/gritter.css">
    ...
    <body>
        ...
        <script type="text/javascript" src="<?php echo $this->webroot; ?>plugins/gritter/js/jquery.gritter.js"></script>
