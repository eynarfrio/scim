...
<?php echo $this->Form->create('Materiale', array('action' => 'registra_can', 'data-parsley-validate')); ?>
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <?php echo $this->Form->text('Ingreso.cantidad', array('class' => 'form-control', 'required', 'placeholder' => 'Ingrese la cantidad','type' => 'number')); ?>
            </div>
        </div>
    </div>
    <div class="form-group">
        <div class="row">
            <div class="col-sm-12">
                ...
                <?php echo $this->Form->textarea('observacion', array('class' => 'form-control', 'placeholder' => 'Observacion')); ?>
            </div>
        </div>
    </div>
    <div class="form-group">
