<div class="modal-header text-center">
    ...
    <div class=" ico-bag mb15 mt15" style="font-size:36px;"><h3 class="semibold modal-title text-info">Marca</h3></div>

</div>
<?php echo $this->Form->create('Marca', array('action' => 'registra', 'data-parsley-validate')); ?>
